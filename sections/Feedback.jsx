  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      <motion.div
        ...
        className="flex-[0.5] lg:max-w-[570px] flex justify-end flex-col
                gradient-05 sm:p-8 p-4 rounded-[32px] border-[1px] border-[#6a6a6a] relative"
      >
        <div className="feedback-gradient" />
        <div>
          <h4 className="font-bold sm:text-[32px] text-[26px] sm:leading-[40px] leading-[30px] text-white">
            Samatha
          </h4>
        ...
        <p className="mt-[24px] font-normal sm:text-[18px] text-[18px] sm:leading-[45px] leading-[39px] text-white">
